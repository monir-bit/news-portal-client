 <div id="marque" style="background: #F3F3F3;padding: 0; height: auto;" class="d-flex align-items-center">
    <div class="bg-danger text-white pt-2 pb-2 ps-3 pe-3">শিরোনাম </div>
   ...
   GetData('/get-marquee/2023-03-26', function (res) {
       if(res.status === 200){
           res.data.forEach(function (item){
               $('#marque-news').append(`
                    <a href="/get-news/${item.id}" style="text-decoration:none;color: black;" class="ps-2 pe-2 d-inline-block border-danger border-right">  

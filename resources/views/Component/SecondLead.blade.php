<div id="secondLead" class="section-container">
    <div class="row">
        <div  class="endNews col-12 sm-6 col-md-4 col-lg-3">
	        ...
	        <div class="row px-2" id="">
               <a href="/latest-news" class="btn btn-danger" >সর্বশেষ</a>
            </div>
            {{--                Advertise--}}
            <div id="home_second_lead_left" class="advertise mt-1 mb-3 text-center overflow-hidden">
...
<script>
  ...
  /*  Advertise('/advertise/home_second_lead_left_add',$('#home_second_lead_left'))*/
    ...
    function HomeSecondLead(){
        GetData('/get-all-news/1/second_lead/6/0', function(response){
            if(response.status === 200){
                let data = response.data;
                let order = 9;

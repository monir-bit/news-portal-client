<div class="section-container">
    <div class="shadow-sm border-bottom border-secondary  p-2  d-flex justify-content-between align-items-center" id="navbarSupportedContent">
            ...
            <div class="row justify-content-md-between  justify-content-center">
                <div class="areaChose col-12 col-md-6 col-lg-12  mt-3">     
                    <div class="filter-body">             
                        <h3 class="border-bottom border-top bg-light p-2">সারা বাংলাদেশ</h3>

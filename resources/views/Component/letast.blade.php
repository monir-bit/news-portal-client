<div id="secondLead" class="section-container">
    <div class="row">
        <div  class="endNews col-12 sm-6 col-md-8 col-lg-8">
            <!-- Nav pills -->
            <ul class="nav border-bottom  mb-2  pb-1 pt-1 border-top nav-pills">
                <li class="nav-item">
                    <a class="nav-link text-dark active f-20" data-bs-toggle="pill" href="#home">
এই মুহূর্তের সর্বশেষ </a>
                </li>
                <li class="nav-item">
                    <a  class="nav-link text-dark f-20" data-bs-toggle="pill" href="#menu1">
সর্বাধিক পঠিত </a>
                </li>
            </ul>
            ...
            {{--                Advertise--}}
            <div id="home_second_lead_leftold" class="advertise mt-5 mb-3 text-center overflow-hidden">

            </div>
        </div>

        <div class=" col-12 sm-6 col-md-4 col-lg-4">
                ...
                $('#SorbosesNews').append(`
                    <a href="/get-live-news/${data[0].id}" class="news  p-0 link border-bottom mt-2 mb-2">
                        <div class="position-relative">
                            <img style="height: 115px;" class="image" src="${data[0].image}">
                            <div class="position-absolute text-center text-white " style="height: 100px;width: 90%;background: rgba(255,255,255,1);bottom: 0">
...
<!--                                <div class="f-13"><i class="fas fa-tags" style="margin-right: 5px"></i> ${category} </div>-->
        ...
        GetData('/get-all-latest/90/0', function (response){
            if(response.status === 200){
                let data = response.data;
                let order = 12;
                for(let i = 0; i < data.length; i++){
                    ...
                    //     if(data[i].order == j+1){
                            ...
                            <a href="/get-news/${data[i].id}" class="news p-0 link border-bottom mt-2 mb-2">
                                <img  style="height: 100px;" class="image" src="${data[i].image}">
                                <div>
                                    <h1 class="title line-2" style="margin-bottom: 5px!important;">${data[i].title}</h1>

<div class="row section-container" id="sports">
    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
        <div class="bg-light mt-5 border-bottom border-secondary shadow-sm">
        ...
        <div class="row mt-3">
            ...
            <div class="col-12 col-md-4 col-lg-6">
                <div class="" id="sportsSecondLead" style="height: 400px">
                    <!--SPORTS SECOND LEAD -->
                </div>
                <div>
            ...
            <div class="col-12 col-md-4 col-lg-3">
                <div id="sportsThreeLead">
                   <!--FIRST LEAD-->
                </div>

                <div class="mt-3">
                    <div class="titleNews2 mt-4 border-left border-right" id="threeSportSubNews">
                        <!--FIRST LEAD SUBNEWS -->
                    </div>
                </div>
            </div>
...
<script>
                    ...
                    if(response.status === 200){
                        ...
                        for(let i = 0; i < data.length; i++){
                            ...
                            `);
                             ...
                             <a href="/get-news/${data[i].id}" class="card link" style="height: 400px">
    ...
    function AllSportsNews(){
        ...
        GetData('/get-all-news/4/sub_lead_news/2/3',function(response){
...
FirstLeadSubNews(data[i].id,data[i].title,data[i].image,data[i].date);
        ...
        GetData('/get-all-news/4/second_lead/2/5',function(response){
            if(response.status === 200){
                let data = response.data;
             //   let order = 4;
                for(let i = 0; i < data.length; i++){
        ...
        // SPORTS Third LEAD SUB NEWS
        GetData('/get-all-news/4/second_lead/2/7',function(response){
            if(response.status === 200){
                let data = response.data;
                for(let i = 0; i < data.length; i++){
                    ThirdLeadSubNews(data[i].id,data[i].title,data[i].image,data[i].date);
                }
            }
        })
    }
    ...
    function ThirdLeadSubNews(newsID,title,image,time){
        $('#threeSportSubNews').append(`
             <a href="/get-news/${newsID}" class="news link border-bottom mt-2 mb-2">
                <img class="image" src="${image}">
                <div>
                    <h5 class="title">${title}</h5>

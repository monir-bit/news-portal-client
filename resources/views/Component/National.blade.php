<div id="national" class="row section-container justify-content-between">
    <div class="national col-12 col-md-8  mt-3 col-lg-9">
        <div class="nation-header d-flex justify-content-between align-items-center p-2 bg-light border-bottom border-secondary shadow-sm">
...
<script>
    ...
    function HomeNational(){
        ...
        GetData('/get-all-news/2/lead_news/6/0', function(response){
            if(response.status === 200){
                let data = response.data;
                //let order = 5;
                for(let i = 0; i < data.length; i++){
        ...
        GetData('/get-all-news/2/side_bar_news/8/4', function(response){
            if(response.status === 200){
                let data = response.data;
               // let order = 7;
                for(let i = 0; i < data.length; i++){
        ...
        function NationalLead(newsID, title,image){
            ...
            <div class="mt-3  col-12 col-sm-4  col-md-4   col-lg-4  border-0" style="padding-right: 0">

<div class="row section-container">
    ...
    <script>
        ...
        function AllHealthNews(){
            ...
            GetComponentSubNews('/get-all-news/7/side_bar_news/1/1','#HealthSubNews');
        }
        /*---------- END Health Section ------------*/
        ...
        function AllForeignNews(){
            ForeignLeadNews('/get-all-news/10/lead_news/4/0','#foreignLeadNews')
            ForeignRightNews('/get-all-news/10/side_bar_news/7/5','#foreignRightNews')
        }
        ...
        function AllJobsNews(){
            ...
            GetComponentSubNews('/get-all-news/13/side_bar_news/1/1','#JobsSubNews');
        }
        /*---------- END Jobs Section ------------*/

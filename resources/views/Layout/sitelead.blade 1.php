<div class="section-container position-relative">
    <div class="container-fluid">
        <div id="siteLead" class="pt-2 pb-2 d-flex justify-content-between align-items-center">
            ...
            <div class="siteLogo">
                <a href="/"><img  src="{{asset("img/logo 2.png")}}" alt="site logo"></a>
            </div>
            <div class="siteRight">
                <div class="siteLanguage text-end f-16">
                    <label style="margin-right: 10px;" class="d-none d-sm-inline">সংস্করন </label>
                    <a href="https://en.breakingnewsbd.net" class="btn btn-default border">English</a>
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <a href="https://www.facebook.com/bnbd247" class="col"><img height="15px" src="{{asset("img/f.png")}}" alt="site logo"></a>
                    <a href="https://www.youtube.com/@bnbd247" class="col"><img height="15px" src="{{asset("img/y.png")}}" alt="site logo"></a>
                    <a href="https://twitter.com/bnbd247" class="col"><img height="15px" src="{{asset("img/t.png")}}" alt="site logo"></a>
                    <a href="https://www.instagram.com/bnbd247" class="col"><img height="15px" src="{{asset("img/i.png")}}" alt="site logo"></a>
                </div>
            </div>
        </div>
    </div>

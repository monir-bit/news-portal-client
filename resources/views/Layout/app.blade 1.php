...
<script type="text/javascript" src="https://platform-api.sharethis.com/js/sharethis.js#property=64d4975fb7b81400124a69d9&product=inline-share-buttons&source=platform" async="async"></script>
    <script>
   ...
   {{--  Google tag (gtag.js) --}}
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-YGTM85H945"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'G-YGTM85H945');
    </script>

      <script>
          let front_url = "https://bnbd24.net";
      </script>
      <style>
      .national-bongo{
          display: none;

...
@section('content')
    <div id="we">
        <div id="" class="we-item section-container mt-3">
                                <div class="row">
                                    @foreach($image as $img)
                                    <div class="col-md-12 text-center">
                                        <img src="{{$img->image_file}}" style="height: 525px;object-fit: cover;width: 85%">
                                        <h4 class="mt-3 mb-0 text-center">{{$img->title}}</h4>
                                    </div>
                                    @endforeach
                            </div>
        </div>

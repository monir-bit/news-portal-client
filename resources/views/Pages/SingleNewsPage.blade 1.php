                    ...
                    $('#RelatedNews').append(`
                     <a href="/get-news/${item.id}" class="news link border-bottom">
                            ...
                            <div>
                                ...
                                <div class="hour"><i class="fas  fa-clock" style="margin: 0 5px 0 0;"></i>${site.localeDate(item.updated_at)}</div>
                            </div>
                        </a>
                `)
                })
            ...
            $('#news').append(`
                    <div class="news-item" id="${newsID}">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="news-date">hh${site.localeFullDate(news.updated_at)}  <img src="https://www.svgimages.com/svg-image/s5/tag-icon-256x256.png" height="15px"> ${catName} </div>
                            <ul class="nav">
                            <li class="nav-item">
                            <a id="" class="nav-link bg-light">Shares <?php echo $st;  ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link icon-link" href="https://www.facebook.com/sharer/sharer.php?u=${site.front_site_url+''+getUrl}" target="_blank"><img height="15px" src="{{asset("img/f.png")}}" alt="site logo"></a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link icon-link" href="http://twitter.com/share?text=text goes here&url=${site.front_site_url+''+getUrl}" target="_blank"><img height="15px" src="{{asset("img/t.png")}}" alt="site logo"></a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link icon-link" href="whatsapp://send?text=${site.front_site_url+''+getUrl}"><img height="15px" src="{{asset("img/w.png")}}" alt="site logo"></a>
                                </li>
                                <li class="nav-item d-none d-sm-block">
                                    <a class="nav-link icon-link newsLinkCopy" href="whatsapp://send?${site.front_site_url+''+getUrl}"><img height="15px" src="{{asset("img/c.png")}}" alt="site logo"></a>
                                </li>
                        ...
                        <a data-lg-size="1400-1400" href="${news.image}" class="col-6 mt-4" data-src="${news.image}" data-sub-html="<h4>${item.title}</h4>">
                                <div class="newsCardOverlay position-relative">
                                <a class="example-image-link" href="${news.image}" data-lightbox="example-2" data-title="Optional caption." data-sub-html="<h4>${item.title}</h4>"><img class="example-image" style="height: 450px;object-fit: cover;width: 100%" src="${news.image}" alt="image-1"/></a>
                                    
                                    <div  class="cardOverlay w-100 position-absolute" style="bottom: 0;">
                                        <h5 class="card-title text-white line-1 p-2">${news.title}</h5>
                                    </div>
                                </div>
                            </a>
